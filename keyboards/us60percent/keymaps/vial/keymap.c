    ...
    [0] = LAYOUT(
              KC_ESCAPE,            KC_1,            KC_2,            KC_3,
               ...
               KC_EQUAL,    KC_BACKSLASH,          KC_TAB,            KC_Q,
                   KC_W,            KC_E,            KC_R,            KC_T,
                   KC_Y,            KC_U,            KC_I,            KC_O,
                   KC_P, KC_LEFT_BRACKET, KC_RIGHT_BRACKET,        KC_GRAVE,
           KC_CAPS_LOCK,            KC_A,            KC_S,            KC_D,
                   KC_F,            KC_G,            KC_H,            KC_J,
                   KC_K,            KC_L,    KC_SEMICOLON,        KC_QUOTE,
               KC_ENTER,       KC_DELETE,   KC_LEFT_SHIFT,            KC_Z,
                   KC_X,            KC_C,            KC_V,            KC_B,
                   KC_N,            KC_M,        KC_COMMA,          KC_DOT,
               KC_SLASH,        KC_MINUS,  KC_RIGHT_SHIFT,     KC_LEFT_GUI,
           KC_LEFT_CTRL,     KC_LEFT_ALT,  KC_TRANSPARENT,        KC_SPACE,
             KC_MS_BTN1,      KC_MS_BTN2,  KC_TRANSPARENT,  KC_TRANSPARENT,
           KC_RIGHT_ALT,         KC_MENU,    KC_RIGHT_GUI
    ),
    [1] = LAYOUT(
